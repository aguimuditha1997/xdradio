			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
						<div class="card-title">Data Video Materi</div>
                        <a href="{{route('materi.create')}}" class="btn btn-primary btn-sm ml-auto"><i class="fa-solid fa-plus"></i> Tambah Materi</a>
					</div>
				</div>
				<div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src=" {{ asset('upload/'. $row->gambar_materi)}}" width="100">
                                    </td>
                                    <td>
