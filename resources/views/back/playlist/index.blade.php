			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
                        ...
                        <a href="{{route('playlist.create')}}" class="btn btn-primary btn-sm ml-auto"><i class="fa-solid fa-plus"></i> Tambah Playlist</a>
					</div>
				</div>
				<div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src=" {{ asset('upload/'. $row->gambar_playlist)}}" width="100">
                                    </td>
                                    <td>
