			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
						<div class="card-title">Form Playlist Video {{$playlist->judul_playlist}}</div>
                    ...
                    <form method="post" action="{{route('playlist.update',$playlist->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select  name="is_active" class="form-control">
                                ...
                                <option value="0" {{$playlist->is_active == '0' ? 'Selected' : ''}}>Draf</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                                ...
                                <img src=" {{ asset('upload/'. $playlist->gambar_playlist)}}" width="100">
                        </div>
