			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
                        ...
                        <a href="{{route('artikel.create')}}" class="btn btn-primary btn-sm ml-auto"><i class="fa-solid fa-plus"></i> Tambah Artikel</a>
					</div>
				</div>
				<div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src=" {{ asset('upload/'. $row->gambar_artikel)}}" width="100">
                                    </td>
                                    <td>
